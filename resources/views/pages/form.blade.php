...
<div class="form-group">
  ...
  <input id="venue-name" name="venue-name" type="text" class="form-control input-md" placeholder="Venue" >    
  </div>
...
Give either a street address or cross streets. Ideally this value should be parseable by online maps such as Google Maps. If you haven't chosen a location yet, just say "TBA" for now. <a href="#">More</a></p>
  <input id="venue-address" name="venue-address" type="text" placeholder="Address" class="form-control input-md" required="">
</div>
...
<div class="form-group">
  ...
  <div class="">
    <button id="event-submit" name="event-submit" class="btn btn-lg btn-primary">Add this event</button>
  </div>
</div>
